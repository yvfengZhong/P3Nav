export PATH=$PATH:~/liufanfan/workspace/RoboFlamingo
export PYTHONPATH=$PYTHONPATH:~/liufanfan/workspace/RoboFlamingo

source ~/yanfeng/software/anaconda3/bin/activate RoboFlamingo_yiyang
...
export DISPLAY=:99
#export PYTHONPATH=~/liufanfan/workspace/RoboFlamingo
