...
if __name__ == "__main__":
    ...
    tokenizer = AutoTokenizer.from_pretrained("~/bn/robotics/lxh/mpt-1b-redpajama-200b-dolly", local_files_only=True)
    tokenizer.add_special_tokens(
        {"additional_special_tokens": ["<|endofchunk|>", "<image>"]}
    )
    tokenizer.add_special_tokens({"pad_token": "<PAD>"})
    seq_len = 12
    data_dir = "~/bn/robotics-data-hl/real_data/mode1_data_pick_place_001_1023/"
